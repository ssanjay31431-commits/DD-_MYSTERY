    ...
    <div className="p-8 space-y-6 max-w-6xl mx-auto text-white">
      <div className="flex items-center justify-between pb-4 border-b border-purple-500/20">
        ...
        <button
          ...
          className="px-4 py-2 rounded-xl bg-purple-600/20 hover:bg-purple-600/40 text-purple-300 border border-purple-500/30 text-xs font-bold flex items-center gap-2"
        >
      ...
      {loading ? (
        ...
        <div className="glass-panel p-12 text-center rounded-3xl border border-purple-500/20 max-w-md mx-auto space-y-3">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
                  ...
                  <div className="lg:col-span-5 space-y-3">
                    <div className="flex items-center justify-between">
                      <span className="font-mono text-base font-black text-pink-400 bg-slate-950 px-3 py-1 rounded-xl border border-purple-500/30">
                        #{displayOrderId}
                      </span>
                    ...
                    <div className="space-y-1.5 text-xs text-slate-300 pt-2 border-t border-slate-800">
                      <div className="flex items-center gap-2">
                        ...
                        <strong className="text-white text-sm">{customerObj.name || addr.fullName || 'Customer'}</strong>
                      </div>
                  ...
                  {/* Screenshot Preview */}
                  <div className="lg:col-span-4 flex flex-col items-center justify-center p-3 rounded-2xl bg-slate-950 border border-slate-800 space-y-2">
                    <span className="text-xs font-bold text-slate-400 flex items-center gap-1">
                      <CreditCard className="w-3.5 h-3.5 text-pink-400" /> Payment Screenshot
                    </span>
                    {screenshot ? (
                      <div className="relative group cursor-pointer" onClick={() => setSelectedScreenshot(screenshot)}>
                        <img
                          src={screenshot}
                          alt="Payment Screenshot"
                          className="max-h-40 rounded-xl object-contain border border-purple-500/40 group-hover:opacity-80 transition-all"
                        />
                  ...
                  {/* Action Button */}
                  <div className="lg:col-span-3 flex flex-col justify-center items-stretch h-full space-y-3">
                    {isVerified ? (
      ...
      {selectedScreenshot && (
        <div className="fixed inset-0 z-50 bg-slate-950/90 backdrop-blur-md flex items-center justify-center p-4">
          <div className="relative max-w-3xl w-full bg-slate-900 border border-purple-500/40 rounded-3xl p-6 space-y-4 max-h-[90vh] flex flex-col">
