export const DEFAULT_PRODUCTS = [
  {
    ...
    stock: 50,
    highlights: ['100% Original 90s Candy', 'Free Custom Birthday Greeting', 'Advance ₹100 + COD Available', 'Dispatched in 24 Hours'],
    contents: [
  ...
  },
  {
    ...
    stock: 100,
    highlights: ['5 Secret Chocolate Gifts', 'Chance for MrBeast Bar', 'Budget Friendly Birthday Gift', 'Advance ₹39.80 + COD'],
    contents: [
  ...
  },
  {
    ...
    stock: 30,
    highlights: ['Custom Name Acrylic LED Light', 'Personalized Mug', '20+ Deluxe Birthday Items', 'Advance ₹100 + COD Available'],
    contents: [
